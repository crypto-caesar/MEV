''' Instead of retrieving pool and token addresses by hand, use multicall.
A script that retrieves addresses for every known liquidity pool on Avalanche 
(TraderJoe, SushiSwap, and Pangolin), plus the token addresses inside those pools
